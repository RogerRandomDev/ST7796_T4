/******************************************************************************
*  ST7796_T4 library for driving an ST7796 screen via SPI with a Teensy 4/4.1
...
#define ST7796_T4_ALWAYS_INLINE __attribute__((always_inline))
...
namespace ST7796_T4
{
    ...
    *******************************************************************************************/
    ...
    public:
        ...
        **/
        ST7796_T4::StatsVar statsTime() const { return _stats_time; }
        ...
        **/
        ST7796_T4::StatsVar statsSize() const { return _stats_size; }
    ...
    private:
        ...
        ST7796_T4::StatsVar _stats_size;   // statistics on buffer size
        ST7796_T4::StatsVar _stats_time;   // statistics on compute times. 


        /** Read a value */
        uint32_t _read_encoded(int & pos) ST7796_T4_ALWAYS_INLINE
            {
        ...
        void _write_encoded(uint32_t val)  ST7796_T4_ALWAYS_INLINE
            {
            if (val <= 127)
